...
namespace AdvancedTaskControl.Data.Migrations
{
    ...
    [Migration("20210728142413_Add password crypt")]
    partial class Addpasswordcrypt
    {
            ...
            modelBuilder.Entity("AdvancedTaskControl.API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -9991,
                            Password = "$2a$11$PmsJAPtBd/KuDaMPjVcKo.JtUbuGZAXDilGbpv6MVeU/aU4gAi./u",
                            Role = "ADM",
                            Username = "Admin"
                        },
                        new
                        {
                            Id = -9992,
                            Password = "$2a$11$IF/Lu0bggDgfnZAuXnwKCutMTn6LSZmRWtFlu0dUxKuSX8w9j/4Gu",
                            Role = "USER",
                            Username = "User"
                        });
                });
